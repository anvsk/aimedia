...
the short software gate; the constrained HEVC path has also passed a 90-second real-GPU software
gate through H.264/AAC MPEG-TS/SRT output, including source reconnect and network impairment. RTSP
and the HEVC sub-capability remain experimental until physical-camera and long-run evidence exists.
